...
// FreeRTOS event group to handle status of different stages of disPOD bootup
const int DIS_POD_WIFI_CONNECTING_BIT		= BIT0;
const int DIS_POD_WIFI_CONNECTED_BIT		= BIT1;
const int DIS_POD_SNTP_UPDATED_BIT			= BIT2;
const int DIS_POD_BLE_CONNECTING_DEV1_BIT	= BIT3;
const int DIS_POD_BLE_CONNECTED_DEV1_BIT	= BIT4;
const int DIS_POD_BLE_CONNECTING_DEV2_BIT	= BIT5;
const int DIS_POD_BLE_CONNECTED_DEV2_BIT	= BIT6;
const int DIS_POD_SD_AVAILABLE_BIT			= BIT7;
static EventGroupHandle_t s_disPod_event_group;
...
void wifi_init_sta()
{
    ...
    ESP_LOGI(GATTC_TAG, "connect to ap SSID:%s password:%s",
             EXAMPLE_ESP_WIFI_SSID, EXAMPLE_ESP_WIFI_PASS);
}

// TODO: WiFi code - END OF WIFI BLOCK


// TODO start sntp BLOCK
